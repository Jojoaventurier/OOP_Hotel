Exercice de formation. A partir de captures d'écran, réaliser une application en POO permettant la gestion de réservations de chambres par des clients dans différents hôtels.
On doit pouvoir :
